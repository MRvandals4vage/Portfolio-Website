...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-accent1 text-white hover:opacity-90",
        destructive: "bg-highlight text-gray-900 hover:opacity-90",
        outline: "border border-border bg-background hover:bg-surface hover:text-accent2",
        secondary: "bg-surface text-textPrimary hover:bg-surface/80",
        ghost: "hover:bg-surface/60 hover:text-accent2",
